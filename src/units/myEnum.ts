namespace MyEnum {
  ...
  export enum unitBaseField { "ID", "unitName", "unitType", "linkman", "TEL", "parentUnit", "unitAddress", "unitEmail", "unitURL", "logo", "remark", "parentUnitID", "unitTreeID", "adminAccountID", "parentAdminAcountID", "createTime", "lastChangeTime" }
